...
export class Renderer {
  ...
  /**
   * The current state of the renderer. Do not change. To change the state, use 'loadTemplate' or 'setSource'.
   * You can also subscribe to the 'onStateChange()' event to be notified when the state changes.
   *
   * @see loadTemplate()
   * @see setSource()
   * @see onStateChange()
